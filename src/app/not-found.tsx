  ...
  return (
    <section className="industrial-surface min-h-[70svh] px-5 pt-32">
      <div className="mx-auto max-w-4xl py-20 text-center">
        <p className="text-sm font-extrabold uppercase tracking-[0.24em] text-amber-300">404</p>
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <Link
            className="rounded-sm border border-white/30 px-5 py-3 text-sm font-extrabold uppercase tracking-[0.12em] text-white"
            href="/contact"
          >
            Contact
          </Link>
