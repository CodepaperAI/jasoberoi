...
export function ReviewAvatar({
  ...
  return (
    <span className={["relative shrink-0", box].join(" ")}>
      <span
        aria-hidden="true"
        className="flex h-full w-full items-center justify-center rounded-full bg-gradient-to-br from-orange-50 to-orange-100 text-orange-600 ring-1 ring-orange-200"
      >
